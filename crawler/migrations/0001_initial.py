...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crawler_website', (
        ...
        db.send_create_signal(u'crawler', ['Website'])

        # Adding model 'Webpage'
        db.create_table(u'crawler_webpage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=200)),
            ('robots_allowed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('website', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crawler.Website'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'crawler', ['Webpage'])


    def backwards(self, orm):
        # Deleting model 'Website'
        db.delete_table(u'crawler_website')

        # Deleting model 'Webpage'
        db.delete_table(u'crawler_webpage')
    ...
    models = {
        u'crawler.webpage': {
            ...
            'website': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['crawler.Website']"})
        },
        u'crawler.website': {
